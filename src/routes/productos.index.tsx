...
export const Route = createFileRoute("/productos/")({
  head: () =>
    buildHead({
      ...
      description:
        "Catálogo de péptidos al mayoreo en México: BPC-157, semaglutida, tirzepatida, retatrutida, CJC-1295, ipamorelin. Mínimo 10 viales. Pago eCartPay.",
      canonical: "/productos",
    ...
    <div className="container mx-auto px-4 py-12 md:py-16">
      <header className="max-w-3xl">
        ...
        <p className="mt-3 text-lg text-muted-foreground">
          Mínimo 10 viales totales — mezcla libre. Packs de 10 / 20 / 30 con descuento. Pago seguro con eCartPay.
        </p>
      </header>
