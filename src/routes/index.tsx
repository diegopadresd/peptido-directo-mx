...
export const Route = createFileRoute("/")({
  head: () =>
    buildHead({
      ...
      description:
        "Compra péptidos al mayoreo en México con 50% de descuento. Mínimo 10 viales, pago seguro, envío 10-20 días. BPC-157, semaglutida, tirzepatida.",
      canonical: "/",
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-3">
            {[
              ...
              { icon: CreditCard, n: "02", t: "Pagas con tarjeta, OXXO o SPEI", d: "Tarjeta, SPEI o efectivo en OXXO. Todo en MXN, recibo formal." },
