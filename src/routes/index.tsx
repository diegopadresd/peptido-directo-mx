...
export const Route = createFileRoute("/")({
  head: () =>
    buildHead({
      ...
      description:
        "Compra péptidos al mayoreo en México con 50% de descuento. Mínimo 10 viales, pago eCartPay, envío 10-20 días. BPC-157, semaglutida, tirzepatida.",
      canonical: "/",
        ...
        <div className="container relative mx-auto px-4 pb-20 pt-16 md:pb-28 md:pt-24">
          ...
          <div className="mx-auto mt-14 grid max-w-4xl grid-cols-2 gap-3 sm:grid-cols-4">
            {[
              ...
              { icon: CreditCard, label: "eCartPay" },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-3">
            {[
              ...
              { icon: CreditCard, n: "02", t: "Pagas con eCartPay", d: "Tarjeta, SPEI o efectivo en OXXO. Todo en MXN, recibo formal." },
