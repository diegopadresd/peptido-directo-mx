        ...
        <div className="rounded-lg border border-border bg-card p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-muted-foreground">
                Los reembolsos aprobados se procesan en un plazo de 5 a 10 días hábiles. El tiempo de reflejo en tu cuenta depende de tu banco o de eCartPay. Transferencias SPEI suelen ser más rápidas; tarjetas de crédito pueden tardar hasta un ciclo de facturación.
              </p>
            </div>
          </div>
        </div>
