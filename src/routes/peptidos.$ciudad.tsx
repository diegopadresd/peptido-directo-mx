...
export const Route = createFileRoute("/peptidos/$ciudad")({
  ...
  head: ({ loaderData }) => {
    ...
    return buildHead({
      ...
      description: `Compra péptidos al mayoreo en ${c.name}, ${c.state}. Mínimo 10 viales, descuentos por volumen, pago seguro Stripe. Envío en ${c.deliveryDays} hábiles.`,
    ...
    <div className="container mx-auto max-w-5xl px-4 py-12 md:py-16">
      ...
      <section className="mt-10 grid gap-4 rounded-xl border border-border bg-card p-6 md:grid-cols-3">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-semibold">Pago Stripe</p>
