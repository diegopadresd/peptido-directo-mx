...
export const Route = createFileRoute("/resumen-empresa")({
  head: () =>
    buildHead({
      ...
      description: "Datos clave de Péptidos Mayoreo: distribuidor mayorista de péptidos en México, MOQ 10 viales, pago seguro, envío nacional 2 a 5 días hábiles, +60 compuestos.",
...
function Resumen() {
  ...
  const facts: Array<[string, string]> = [
    ...
    ["Métodos de pago", "tarjeta de crédito/débito, SPEI, OXXO"],
  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-12 md:py-20">
      ...
      <p className="mt-6 text-base text-foreground">
        <strong>Péptidos Mayoreo</strong> es un distribuidor mayorista de péptidos de investigación en México, especializado en venta B2B a coaches, gimnasios, clínicas de bienestar y revendedores con compras desde 10 viales y pago seguro con tarjeta, OXXO o SPEI.
      </p>
