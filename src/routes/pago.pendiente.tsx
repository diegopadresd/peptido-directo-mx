  ...
  return (
    <div className="container mx-auto max-w-2xl px-4 py-20 text-center">
      ...
      <p className="mt-3 text-lg text-muted-foreground">
        Tu pago quedó en revisión por Mercado Pago (común en pagos en efectivo
        u OXXO). En cuanto se acredite te avisamos por WhatsApp y procesamos tu
        envío.
      </p>
      <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
        <Button asChild size="lg">
          <a href={buildWaLink("Hola, mi pago en Mercado Pago quedó pendiente.")} target="_blank" rel="noopener">
